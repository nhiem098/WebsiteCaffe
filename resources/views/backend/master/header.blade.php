            ...
            <li class="dropdown d-none d-lg-inline-block topbar-dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item">
                        <img src="backend\assets\images\flags\germany.jpg" alt="user-image" class="mr-1" height="12">
                        <span class="align-middle">German</span>
                    </a>

                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item">
                        <img src="backend\assets\images\flags\italy.jpg" alt="user-image" class="mr-1" height="12">
                        <span class="align-middle">Italian</span>
                    </a>

                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item">
                        <img src="backend\assets\images\flags\spain.jpg" alt="user-image" class="mr-1" height="12">
                        <span class="align-middle">Spanish</span>
                    </a>

                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item">
                        <img src="backend\assets\images\flags\russia.jpg" alt="user-image" class="mr-1" height="12">
                    ...
                    <div class="noti-scroll" data-simplebar="">
                        ...
                        <a href="javascript:void(0);" class="dropdown-item notify-item active">
                            <div class="notify-icon">
                                <img src="backend\assets\images\users\user-1.jpg" class="img-fluid rounded-circle"
                                    alt=""> </div>
                        ...
                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                            <div class="notify-icon">
                                <img src="backend\assets\images\users\user-4.jpg" class="img-fluid rounded-circle"
                                    alt=""> </div>
