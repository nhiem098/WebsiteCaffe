                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless table-hover table-nowrap table-centered m-0">
                            ...
                            <tbody>
                                <tr>
                                    <td style="width: 36px;">
                                        <img src="backend\assets\images\users\user-2.jpg" alt="contact-img"
                                ...
                                <tr>
                                    <td style="width: 36px;">
                                        <img src="backend\assets\images\users\user-3.jpg" alt="contact-img"
                                            title="contact-img" class="rounded-circle avatar-sm">
                                    </td>
                                ...
                                <tr>
                                    <td style="width: 36px;">
                                        <img src="backend\assets\images\users\user-4.jpg" alt="contact-img"
                                            title="contact-img" class="rounded-circle avatar-sm">
                                    </td>
                                ...
                                <tr>
                                    <td style="width: 36px;">
                                        <img src="backend\assets\images\users\user-5.jpg" alt="contact-img"
                                            title="contact-img" class="rounded-circle avatar-sm">
                                    </td>
                                ...
                                <tr>
                                    <td style="width: 36px;">
                                        <img src="backend\assets\images\users\user-6.jpg" alt="contact-img"
                                            title="contact-img" class="rounded-circle avatar-sm">
                                    </td>
...
@section('script')
    ...
    <!-- Dashboar 1 init js-->
    <script src="backend\assets\js\pages\dashboard-1.init.js"></script>
@endsection